...
class Gnuplot
{
    ...
    //set the point style
    //Gnuplot& set_points(std::string &stylestr, int style); ///&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
    ...
    //$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
    Gnuplot& plotfile_xyz_custom(const std::string &filename,
    ...
    Gnuplot& plot_xyz_custom(const X &x,
			     const Y &y,
			     const Z &z,
			     const std::string color,
			     int pointtype,
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
template<typename X, typename Y, typename Z>
Gnuplot& Gnuplot::plot_xyz_custom(const X &x,
				  const Y &y,
				  const Z &z,
				  const std::string color,
				  int pointtype,
    ...
    plotfile_xyz_custom(name, 1, 2, 3, title, color, pointtype, pointsize);
