...
/**&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
Gnuplot& Gnuplot::set_point_style(std::string &stylestr, int style) {
    stylestr += "pt ";
    stylestr += style;
    pstyle = stylestr;
    return *this;
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
Gnuplot& Gnuplot::plotfile_xyz_custom(const std::string &filename,
				      const unsigned int column_x,
				      const unsigned int column_y,
				      const unsigned int column_z,
				      const std::string &title,
    ...
    /** Build the point attributes.*/
    std::ostringstream pointStyle;
    pointStyle <<"points pt "<<pointtype<< "  ps "<< pointsize << " linecolor rgb \""<<color<<"\"";
    ...
    if (title == "")
        cmdstr << " notitle with " << pointStyle.str();
    else
        cmdstr << " title \"" << title << "\" with " << pointStyle.str();

     cmd("set palette color");
    // Do the actual plot
    cmd(cmdstr.str());
