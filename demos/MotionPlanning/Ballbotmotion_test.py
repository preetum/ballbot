...
class Robot:
    ...
    def __init__(self):
        ...
        distance = 10
        time.sleep(2)
        self.setMotion(108,200,114,300,115,1500) # l = 108, s = 115, r = 114
    ...
    def setMotion(self,action1,val1,action2,val2,action3,val3):
        """
        Set motion packet
        """
        val1 = int(val1)
        ...
        lb   = val2 % 256
        hb   = (val2 >> 8) % 256
        self.plannerpacket[3] = action2
        self.plannerpacket[4] = hb
        self.plannerpacket[5] = lb

        val3 = int(val3)
        lb = val3 % 256
        hb = (val3 >> 8) % 256
        self.plannerpacket[6] = action3
        self.plannerpacket[7] = hb
        self.plannerpacket[8] = lb
