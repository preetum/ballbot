...
(cl:defmethod cl:initialize-instance :after ((m <goal_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'goal_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cmd_vel_simulator-msg:<goal_msg> is deprecated: use cmd_vel_simulator-msg:goal_msg instead.")))

(cl:ensure-generic-function 'd-val :lambda-list '(m))
(cl:defmethod d-val ((m <goal_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cmd_vel_simulator-msg:d-val is deprecated.  Use cmd_vel_simulator-msg:d instead.")
  (d m))

(cl:ensure-generic-function 'th-val :lambda-list '(m))
(cl:defmethod th-val ((m <goal_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cmd_vel_simulator-msg:th-val is deprecated.  Use cmd_vel_simulator-msg:th instead.")
  (th m))

(cl:ensure-generic-function 'opt-val :lambda-list '(m))
(cl:defmethod opt-val ((m <goal_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cmd_vel_simulator-msg:opt-val is deprecated.  Use cmd_vel_simulator-msg:opt instead.")
  (opt m))
