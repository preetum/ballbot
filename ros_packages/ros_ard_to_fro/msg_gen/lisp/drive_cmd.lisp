...
(cl:defmethod cl:initialize-instance :after ((m <drive_cmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'drive_cmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_ard_to_fro-msg:<drive_cmd> is deprecated: use ros_ard_to_fro-msg:drive_cmd instead.")))

(cl:ensure-generic-function 'drive_speed-val :lambda-list '(m))
(cl:defmethod drive_speed-val ((m <drive_cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_ard_to_fro-msg:drive_speed-val is deprecated.  Use ros_ard_to_fro-msg:drive_speed instead.")
  (drive_speed m))

(cl:ensure-generic-function 'steer_angle-val :lambda-list '(m))
(cl:defmethod steer_angle-val ((m <drive_cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_ard_to_fro-msg:steer_angle-val is deprecated.  Use ros_ard_to_fro-msg:steer_angle instead.")
  (steer_angle m))
